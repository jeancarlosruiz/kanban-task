...
const Logo = () => {
  return (
    <h1>
      <Link
        href="/dashboard"
        className="inline-flex items-center min-h-[4rem] sm:min-h-[5rem] md:min-h-[6rem] sm:min-w-[16.3125rem] md:min-w-[18.75rem] sm:border-e sm:dark:border-r-gray-500 pl-[16px] sm:pl-[24px]"
      >
        <svg
          width="153"
          height="26"
