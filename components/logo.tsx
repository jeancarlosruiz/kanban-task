...
const Logo = () => {
  return (
    <div className="inline-flex items-center min-h-[4rem] sm:min-h-[5rem] md:min-h-[6rem] sm:min-w-[16.3125rem] md:min-w-[18.75rem] sm:border-e sm:dark:border-r-gray-500 ">
      <h1 className="leading-none pl-[16px] sm:pl-[24px]">
        <Link href="/dashboard" className="">
          <svg
            ...
            role="img"
            aria-labelledby="logo-icon-desktop"
            className="hidden sm:block"
          >
            <title id="logo-icon-desktop">Kanban task manager</title>
            <g fill="none" fillRule="evenodd">
              <path
                ...
                className="fill-[#000112] dark:fill-[#FFF]"
                fillRule="nonzero"
              />
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
            role="img"
            aria-labelledby="logo-icon-mobile"
            className="block sm:hidden"
          >
            <title id="logo-icon-mobile">Kanban task manager</title>
